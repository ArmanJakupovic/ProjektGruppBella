...
namespace SudokuMain
{
    class SingleHighscore
    {
        ...
        public string GetScore(int index) { return _name[index] + "\t     " + (DateTime.Today + new TimeSpan(0, 0, _score[index])).ToString("H:mm:ss"); }//Returnerar en sträng med namn och poäng
